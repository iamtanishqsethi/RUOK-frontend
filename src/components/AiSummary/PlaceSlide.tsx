...
import { MapPin, ThumbsUp, AlertTriangle, Navigation } from "lucide-react";
...
const PlaceSlide = ({ positiveHeadline, negativeHeadline }: PlaceSlideProps) => (
    <motion.div
        ...
        className="relative w-full h-full overflow-hidden rounded-3xl bg-gradient-to-br from-orange-400 via-red-500 to-pink-500 p-8 shadow-2xl"
    >
