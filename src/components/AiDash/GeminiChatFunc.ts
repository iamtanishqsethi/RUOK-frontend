...
const ai = new GoogleGenAI({
    apiKey: 'AIzaSyCVqe3WTpc5dN4R6Inx2em9fLDdvg85kzY',  
});
...
const config = {
    ...
    systemInstruction: [
        {
            text: `You are a compassionate, emotionally intelligent mental health assistant designed to provide support like a trained CBT (Cognitive Behavioral Therapy) therapist. You respond in a way that balances professionalism with empathy and friendliness, adapting to the user's tone. You should:
...
export async function getCBTReply(userMessage: string): Promise<string> {
    ...
    try {
        ...
        return 'Oops! Something went wrong while talking to your CBT buddy.';
    }
}
